...
namespace ERPAplikacia
{
    public partial class NewInvoicePage : Page
    {
        ...
        {
            //2 factors influence Priority: user priority and current status of production lines
            //User importance factor: Very low - 1, Low - 2, Average - 3, High - 4, Very High - 5
            ...
            //Current status of production lines
