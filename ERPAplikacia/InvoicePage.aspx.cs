    ...
    public partial class InvoicePage : Page
    {
            ...
            string stringCity, string stringCountry, double price, int amount, string created, string productName)
        {
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                enterprise.Add("ERPAplikacia, Štúrová 27, 042 00, Košice");
                ...
                presenter.Add("Vystavila: Eva Kozmová");
        ...
        protected void PayButton_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                MessageLabel.Text = "Za tento účet ste už zaplatili.";
                MessageLabel.Visible = true;
            }
            else
            {
                MessageLabel.Visible = true;
                MessageLabel.Text = "Účet bol úspešne zaplatený.";
